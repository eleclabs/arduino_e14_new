...
int sw_j1 = 15;  //ESP32 15  
int sw_j2 = 0;   //ESP32 0  
int sw_j3 = 4;   //ESP32 4  
int sw_j4 = 16;  //ESP32 16       
int sw_j5 = 17;  //ESP32 17       

#define DIR1 0    // MCP23S17 GPA0
#define STEP1 1   // MCP23S17 GPA1
#define DIR2 2    // MCP23S17 GPA2
#define STEP2 3   // MCP23S17 GPA3
#define DIR3 4    // MCP23S17 GPA4
#define STEP3 5   // MCP23S17 GPA5
#define DIR4 6    // MCP23S17 GPA6
#define STEP4 7   // MCP23S17 GPA7
#define DIR5 8    // MCP23S17 GPB0
#define STEP5 9   // MCP23S17 GPB1
#define DIR6 10   // MCP23S17 GPB2
#define STEP6 11  // MCP23S17 GPB3
#define DIR7 12   // MCP23S17 GPB4
#define STEP7 13  // MCP23S17 GPB5
...
void setup() {
  ...
  mcp.pinMode(DIR7, OUTPUT);   
  mcp.pinMode(STEP7, OUTPUT);  
...
void stepJ7(int steps, bool direction) {
  mcp.digitalWrite(DIR7, direction ? HIGH : LOW);
  for (int i = 0; i < steps; i++) {
    if (digitalRead(sw_j7) == LOW) {  //เช็คสวิตช์ joy7
      steps = 0;
      break;
    }
    mcp.digitalWrite(STEP7, HIGH);
    delayMicroseconds(1000);  // ความเร็วหมุน (เพิ่มได้ถ้ามอเตอร์สั่น)
    mcp.digitalWrite(STEP7, LOW);
    delayMicroseconds(1000);
  }
}
